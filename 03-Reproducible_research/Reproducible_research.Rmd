...
You can include a piece of data from the calculation inside a text chunk.
    ...
    We have `r knitr::inline_expr('length(x)')` rows in our data.
...
## Demo how to create github account and create a repository
...
```{r engine='bash'}
git clone https://github.com/cb2edu/testgit.git
cd testgit
ls
```
